  ...
  return (
    <main className="onboarding-shell">
      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.section className="onboarding-card" key="welcome" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}>
        ...
        {step === 1 && (
          <motion.section className="onboarding-card" key="privacy" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}>
        ...
        {step === 2 && (
          <motion.section className="onboarding-card" key="camera" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}>
        ...
        {step === 3 && (
          <motion.div key="calibration" className="onboarding-card calibration-card" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <CalibrationPanel onComplete={calibrationComplete} />
          </motion.div>
        )}
        {step === 4 && (
          <motion.section className="onboarding-card" key="ready" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}>
